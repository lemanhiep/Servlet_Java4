...
<body>
	...
	<div class="container">
		...
		<div align="center">
			<a class="btn btn-lg" href="/ASS_SOF3011/Admin/Videos?page=1"> <span
				...
				href="/ASS_SOF3011/Admin/Videos?page=${ page + 1 }"> <span
				class="glyphicon glyphicon-forward"></span>
			</a> <a class="btn btn-lg" href="/ASS_SOF3011/Admin/Videos?page=${ page }">
