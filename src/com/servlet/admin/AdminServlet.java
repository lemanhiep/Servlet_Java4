...
public class AdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * String viewsFavorites = "/views/dashboard/Favorites.jsp"; String
		 * viewsFavorite_User = "/views/dashboard/FavoriteUser.jsp"; String
		 * viewsShared_Friend = "/views/dashboard/sharedFriend.jsp";
